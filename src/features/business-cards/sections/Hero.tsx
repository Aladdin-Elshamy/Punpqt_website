...
export default function BusinessCardsHero() {
      ...
      <div className="flex items-center gap-2.5">
        <Breadcrumb
          links={[
            ...
            {
              label: t("breadcrumb.businessCards"),
              url: "/business-cards",
            },
          ]}
        />
      ...
      <Banner>
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 font-semibold text-sm mt-4">
            <span className="text-primary">{t("stats.products", { count: 6 })}</span>
            <span className="text-muted-foreground">{t("stats.printers", { count: 3 })}</span>
          </div>
        </div>
      </Banner>
    </div>
