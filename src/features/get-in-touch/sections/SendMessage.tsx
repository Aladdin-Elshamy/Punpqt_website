...
const topics = [
  { label: "General Inquiry", value: "general", icon: MessageSquare },
  { label: "Order Support", value: "order", icon: CircleHelp },
  { label: "Become a Vendor", value: "vendor", icon: BriefcaseBusiness },
  ...
  return (
    <section aria-labelledby="send-message-heading">
      ...
      <form className="mt-8 space-y-5">
        ...
        <fieldset>
          <legend className="text-xs font-semibold">Topic</legend>
        ...
        <div>
          ...
          <Textarea id="message" name="message" placeholder="Tell us how we can help..." required className="mt-2 min-h-25 resize-y rounded-2xl border-black/6 bg-[#F4F4F6] px-4 py-3 shadow-none" />
        </div>
